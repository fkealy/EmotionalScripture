...
export const middleEmotions = [
    ...
    { 
        name: "Loved",
        color: "#FF69B4",
        text: "Feeling loved is a fundamental human need.",
        parent: "Comfortable Emotions",
        children: ["Accepted", "Valued", "Cherished"]
    },
    { 
        name: "Confident",
        color: "#FFD700",
        text: "Confidence comes from knowing your worth and abilities.",
        parent: "Comfortable Emotions",
        children: ["Capable", "Assured", "Empowered"]
    }
];
